...
if ($stmt = $mysqli->prepare("UPDATE Users SET Users.profile = ?, Users.curr_long = ?, Users.curr_lat = ? WHERE Users.uid = ?")){
	$stmt->bind_param("ssss", $_GET["profile"], $_GET["longitude"], $_GET["latitude"], $_SESSION['input_username']);
	$stmt->execute();
