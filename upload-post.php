...
<hr>
<?php
	echo "<form action = 'submit-post.php' method='get'><textarea name='message' style = 'width: 600px;' 'maxlength='140'></textarea></input><br/><input type='checkbox' name='add_location' value='yes' checked>include my location<br/><input type='submit' value='submit'/></form>";
?>
</div>
</body>
</html>