...
<h3>Setting</h3>
<hr>
<form action = "update-profile.php" method = "GET">Latitude: <input type = "number" step="0.01" name = "latitude"></input>
<br/>Longitude: <input type = "number" step="0.01" name = "longitude"></input>
<br/>Profile message: <input type = "text" maxlength='140' style='width:600px;' name = "profile"></input><br/><input type="submit" value="Update"></form>
</div>
</body>
</html>